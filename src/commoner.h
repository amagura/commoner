...
// PRIVATE Macros
/////////////////////////////////////////
# if defined(COINT_MCHECK) && defined(HAVE_MCHECK_H)
#  include <mcheck.h>
...
# if defined(HAVE_DECL_ITOA) && !USE_COMMONER_NAMESPACE
#  define COMMONER_ITOA_NS(COMNR_FUNCTION_NAME) comnr_##COMNR_FUNCTION_NAME
# elif !defined(HAVE_DECL_ITOA) && USE_COMMONER_NAMESPACE
#  define COMMONER_ITOA_NS(COMNR_FUNCTION_NAME) comnr_##COMNR_FUNCTION_NAME
# else
#  define COMMONER_ITOA_NS(COMNR_FUNCTION_NAME) COMNR_FUNCTION_NAME
# endif
